...
func (s *UsersApiService) GetUsersBackgrounds(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
...
func (s *UsersApiService) GetUsersEffects(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
...
func (s *UsersApiService) GetUsersEngines(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
...
func (s *UsersApiService) GetUsersLevels(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
...
func (s *UsersApiService) GetUsersParticles(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
...
func (s *UsersApiService) GetUsersSkins(ctx context.Context, userId string, localization string, page float32, keywords string) (ImplResponse, error) {
