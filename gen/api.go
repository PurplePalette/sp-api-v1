...
type BackgroundsApiServicer interface { 
	...
	GetBackgroundList(context.Context, string, float32, string) (ImplResponse, error)
}
...
type EffectsApiServicer interface { 
	...
	GetEffectList(context.Context, string, float32, string) (ImplResponse, error)
}
...
type EnginesApiServicer interface { 
	...
	GetEngineList(context.Context, string, float32, string) (ImplResponse, error)
}
...
type LevelsApiServicer interface { 
	...
	GetLevelList(context.Context, string, float32, string) (ImplResponse, error)
}
...
type ParticlesApiServicer interface { 
	...
	GetParticleList(context.Context, string, float32, string) (ImplResponse, error)
...
type SkinsApiServicer interface { 
	...
	GetSkinList(context.Context, string, float32, string) (ImplResponse, error)
}
...
type TestsApiServicer interface { 
	...
	GetTestsBackgrounds(context.Context, string, string, float32, string) (ImplResponse, error)
	GetTestsEffects(context.Context, string, string, float32, string) (ImplResponse, error)
	GetTestsEngines(context.Context, string, string, float32, string) (ImplResponse, error)
	GetTestsLevels(context.Context, string, string, float32, string) (ImplResponse, error)
	GetTestsParticles(context.Context, string, string, float32, string) (ImplResponse, error)
	GetTestsSkins(context.Context, string, string, float32, string) (ImplResponse, error)
}
...
type UsersApiServicer interface { 
	...
	GetUsersBackgrounds(context.Context, string, string, float32, string) (ImplResponse, error)
	GetUsersEffects(context.Context, string, string, float32, string) (ImplResponse, error)
	GetUsersEngines(context.Context, string, string, float32, string) (ImplResponse, error)
	GetUsersLevels(context.Context, string, string, float32, string) (ImplResponse, error)
	GetUsersParticles(context.Context, string, string, float32, string) (ImplResponse, error)
	GetUsersSkins(context.Context, string, string, float32, string) (ImplResponse, error)
}
